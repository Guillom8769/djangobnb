...
from .views import UserViewSet, PlaceViewSet, ReviewViewSet, AmenityViewSet, CountryViewSet, CityViewSet
from . import views
...
urlpatterns = [
    ...
    path('places/<uuid:pk>/', views.place_detail, name='place_detail'),
    path('places/<uuid:pk>/edit/', views.place_update, name='place_update'),
    path('places/<uuid:pk>/delete/', views.place_delete, name='place_delete'),
